...
func main() {
	...
	experiments.OKXBenchParallel(twoTo14, 2, 8)
	println("Test for ", twoTo14, " total users, with 1024 transaction in this batch, with 4 cores")
	experiments.OKXBenchParallel(twoTo14, 2, 4)
	println("Test for ", twoTo14, " total users, with 1024 transaction in this batch, with 3 cores")
	experiments.OKXBenchParallel(twoTo14, 2, 3)
	println("Test for ", twoTo14, " total users, with 1024 transaction in this batch, with 1 cores")
	experiments.OKXBenchParallel(twoTo14, 2, 1)

	println("Test for ", twoTo15, " total users, with 1024 transaction in this batch, with 8 cores")
	experiments.OKXBenchParallel(twoTo15, 2, 8)
	println("Test for ", twoTo15, " total users, with 1024 transaction in this batch, with 4 cores")
	experiments.OKXBenchParallel(twoTo15, 2, 4)
	println("Test for ", twoTo15, " total users, with 1024 transaction in this batch, with 3 cores")
	experiments.OKXBenchParallel(twoTo15, 2, 3)
	println("Test for ", twoTo15, " total users, with 1024 transaction in this batch, with 1 cores")
	experiments.OKXBenchParallel(twoTo15, 2, 1)

	// println("Test for ", twoTo16, " total users, with 1024 transaction in this batch, with 8 cores")
	// experiments.OKXBenchParallel(twoTo16, 2, 8)
	// println("Test for ", twoTo16, " total users, with 1024 transaction in this batch, with 4 cores")
	// experiments.OKXBenchParallel(twoTo16, 2, 4)
	// println("Test for ", twoTo16, " total users, with 1024 transaction in this batch, with 3 cores")
	// experiments.OKXBenchParallel(twoTo16, 2, 3)
	// println("Test for ", twoTo16, " total users, with 1024 transaction in this batch, with 1 cores")
	// experiments.OKXBenchParallel(twoTo16, 2, 1)

	// println("Test for ", twoTo17, " total users, with 1024 transaction in this batch, with 8 cores")
	// experiments.OKXBenchParallel(twoTo17, 2, 8)
	// println("Test for ", twoTo17, " total users, with 1024 transaction in this batch, with 4 cores")
	// experiments.OKXBenchParallel(twoTo17, 2, 4)
	// println("Test for ", twoTo17, " total users, with 1024 transaction in this batch, with 3 cores")
	// experiments.OKXBenchParallel(twoTo17, 2, 3)
	// println("Test for ", twoTo17, " total users, with 1024 transaction in this batch, with 1 cores")
	// experiments.OKXBenchParallel(twoTo17, 2, 1)

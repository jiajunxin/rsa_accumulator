...
func main() {
	...
	experiments.OKXBenchParallel(twoTo14, 2)

	println("Test for ", twoTo15, " total users, with 1024 transaction in this batch, with 8 cores")
	experiments.OKXBenchParallel(twoTo15, 2)

	println("Test for ", twoTo16, " total users, with 1024 transaction in this batch, with 8 cores")
	experiments.OKXBenchParallel(twoTo16, 2)

	println("Test for ", twoTo17, " total users, with 1024 transaction in this batch, with 8 cores")
	experiments.OKXBenchParallel(twoTo17, 2)

	println("Test for ", twoTo18, " total users, with 1024 transaction in this batch, with 8 cores")
	experiments.OKXBenchParallel(twoTo18, 2)
}

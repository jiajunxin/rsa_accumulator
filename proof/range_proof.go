...
type RPProver struct {
	...
	randMList   rpRandCoins
	randRList   rpRandCoins
	randSList   rpRandCoins
	randS       *big.Int
}
...
func calDiList(pp *PublicParameters, m, s rpRandCoins) [squareNum]*big.Int {
...
func (r *RPVerifier) VerifyResponse(response *RPResponse) bool {
	...
	for i := 0; i < squareNum; i++ {
		firstFourParamList[i] = new(big.Int).Exp(r.pp.G, response.Z4[i], r.pp.N)

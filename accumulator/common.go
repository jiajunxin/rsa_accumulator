...
// G2048String is G pre-generated by hashing N through the function GenerateG(), note that any random number mod N should be work as a generator with overwhelming probability

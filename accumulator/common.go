...
const (
	...
	// N2048String stores the modulus N for RSA accumulator
	...
	// G2048String stores the generator g for RSA accumulator
	...
	// H2048String stores the generator h for RSA accumulator
